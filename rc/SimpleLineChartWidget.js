define([
  ...
  SimpleLineChartWidget.prototype.doInitialize = function (dom) {
    ...
    baja.rpc({
      ...
      .catch(function (error) {
        widget.jq().html(
          "Your station is not licensed for this widget: " + error.message
        );
  ...
  SimpleLineChartWidget.prototype.doLoad = function () {
    ...
    if (value && value.$tableData) {
      var historyReq = value.$tableData.req.o;
    ...
    var ord = value
      ? value.getNavOrd().relativizeToSession().toString()
      : widget.$ord;
    ...
    baja.Ord.make(ord)
      ...
      .then(function (component) {
        component
          ...
          .each(function (slot) {
            var historyExtOrd = component.get(slot).getNavOrd().toString();
