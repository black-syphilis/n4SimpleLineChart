define("nmodule/simpleLineChart/rc/simpleLineChartWidget", [
  "nmodule/simpleLineChart/rc/SimpleLineChartWidget"
...
define("nmodule/simpleLineChart/rc/SimpleLineChartWidget", [
  ...
  function renderChart(widget, historyData) {
    ...
    historyData.legendx =
      historyData.width / 2 - parseInt(legendLocation[0]);

    historyData.legendy =
      historyData.height - parseInt(legendLocation[1]);
            ...
            baja.Ord.make(historyExtOrd)
              ...
              .then(function (resolvedHistoryExt) {
                ...
                baja.Ord.make(historyConfigOrd)
                  ...
                  .catch(function (error) {
                    baja.error(
                      "ORD Error getting history historyConfigOrd: " +
                        error
                    );
                  });
              })
              .catch(function (error) {
                baja.error(
                  "ORD Error getting history ext component: " +
                    error
                );
              });
          });
